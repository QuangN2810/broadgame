...
<head>
    ...
    <!-- Favicon Icon Css -->
    <link rel="icon" type="image/jpg" sizes="32x32" href="img/web1.jpg">
    <!-- Animation CSS -->
                ...
                ?>
                    ...
                    <div class="col-md-12" style="background: rgba(240, 242, 245, 1); border: 1px solid #dee2e6">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <td class="text-center td-image bg-black ">Hình ảnh</td>
                                    <td class="text-center td-name bg-black ">Tên sản phẩm</td>
                                    <td class="text-center td-qty bg-black ">Số lượng</td>
                                    <td class="text-center td-price bg-black ">Đơn giá</td>
                                    <td class="text-center td-total bg-black ">Tổng cộng</td>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($_SESSION["cart_item"] as $item) {
                                    ...
                                    //VAT
                                    $total_quantity_vat = ($total_price *0.1)+$total_price;
                                ?>
                                    <tr>
                                        <td class="text-center td-image bg-black "> <img src="./img/sanpham/<?php echo $item['Pic'] ?>" style="width:60px;height:60px"> </td>
                                        <td class="text-center td-name bg-black"><a href='product-detail.php?id=<?php echo $item['ID'] ?>'><?php echo $item['Name'] ?></a></td>
                                        <td class="text-center td-qty bg-black ">
                                        ...
                                        <td class="text-center td-price bg-black  "><?php echo number_format($item['Price'], 0, ".", ".") ?>₫</td>
                                        <td class="text-center td-total bg-black  "><?php echo number_format($item_price, 0, ".", ".") ?>₫</td>
                                    </tr>
                                <?php } ?>
                                <tr>
                                    <td class="cart-total" style="background-color:rgba(238, 238, 238, 1);" colspan="5">
                                        <div>
                                            <div style="padding: 0.5em 0 ">
                                                <span class="float-center w-25"><strong>Thành tiền: </strong></span>
                                                <span><?php echo number_format($total_price, 0, ".", ".") ?>₫</span>
                                            </div>
                                            <div style="padding: 0.5em 0 ">
                                                <span class="float-center w-25"><strong>Mã Giảm giá: </strong></span>
                                                <span>5%</span>
                                            <div style="padding: 0.5em 0 ">
                                                <span class="float-center w-25"><strong>VAT: </strong></span>
                                                <span>10%</span>
                                            </div>
                                            <div style="padding: 0.5em 0 ">
                                                <span class="float-center w-25"><strong>Tổng tiền(có VAT + mã giảm giá): </strong></span>
                                                <span class><?php echo number_format($total_quantity_vat, 0, ".", ".") ?>₫</span>
                                            </div>
                                            <!-- <div style="padding: 0.5em 0 "> -->
                                                <!-- <span class="float-left w-25"><strong>Thuế VAT: </strong></span>
                                                <span><?php echo number_format($total_price, 0, ".", ".") ?>₫</span>
                                            </div>
                                            <div style="padding: 0.5em 0 ">
